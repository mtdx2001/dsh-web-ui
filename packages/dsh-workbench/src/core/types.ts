...
/** Git summary reduced from the aionui-panel git-status payload. */
...
export interface WorkbenchUiState {
  /** The Overview tab is the active explorer tab. */
  overviewActive: boolean
}

/** Default per-project UI state. */
export const DEFAULT_UI_STATE: WorkbenchUiState = { overviewActive: false }
